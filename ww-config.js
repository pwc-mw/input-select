  ...
  properties: {
    ...
    readonly: {
      ...
      bindingValidation: {
        type: "boolean",
        tooltip:
          "A boolean that defines if the input is readonly: `true | false`",
      },
      /* wwEditor:end */
    },
    openInEditor: {
    ...
    disabled: {
      ...
      bindingValidation: {
        type: "boolean",
        tooltip:
          "A boolean that defines if the select is disabled: `true | false`",
      },
      /* wwEditor:end */
    },
    advanced: {
      ...
      bindingValidation: {
        type: "boolean",
        tooltip:
          "A boolean that defines if the user can create options: `true | false`",
      },
      /* wwEditor:end */
    },
    canDeselect: {
    ...
    initialValue: {
      ...
      bindingValidation: {
        type: "string",
        tooltip:
          'A string that defines the initial value: `"option1 || option2"`',
      },
      /* wwEditor:end */
    },
    options: {
    ...
    hintFields: {
      hidden: (content, sidepanelContent, boundProps) =>
        !boundProps.options || content.options,
      label: {
        en: "Options fields",
    ...
    clearIconElement: {
      ...
      defaultValue: {
        ...
        content: {
          default: { icon: "wwi wwi-cross", color: "#9CA3AF", fontSize: "14" },
        },
      },
      navigator: {
        group: "Select",
